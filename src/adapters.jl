...
IntEnum(::Type{T}, ::Type{E}) where {T<:Integer, E<:Base.Enum} = IntEnum(defaultcons(T), E)
IntEnum(::Type{E}) where {T<:Integer, E<:Base.Enum{T}} = IntEnum(defaultcons(T), E)
...
defaultcons(enum::Type{<:Base.Enum}) = IntEnum(enum)
